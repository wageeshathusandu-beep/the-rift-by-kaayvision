...
const galleryItems = [
  { title: 'Official Poster', description: 'The Rift - Coming 2025', image: 'https://i.imgur.com/162JyPV.jpeg', featured: true },
  ...
  { title: 'The Team', description: 'United against the unknown', image: null },
  { title: 'Final Stand', description: 'Humanity fights back', image: null },
]
              ...
              <div className="aspect-[4/3] bg-gradient-to-br from-rift-deep via-rift-blue to-rift-dark flex items-center justify-center relative">
                {item.image ? (
                  ...
                  <img
                    src={item.image}
                    alt={item.title}
                    className="absolute inset-0 w-full h-full object-contain bg-rift-dark"
                  />
                ) : (
                  /* Placeholder */
                  <>
