    ...
    <section id="upcoming" className="py-28 md:py-36 relative overflow-hidden" ref={ref}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <div className="mt-8">
            <a
              href="https://wa.me/94775968200?text=Hello!%20I%20would%20like%20to%20discuss%20a%20film%20production%20project%20with%20you."
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Contact Producer on WhatsApp"
            ...
            >
              ...
              <span className="relative z-10">Contact Producer</span>
            </a>
          </div>
        </motion.div>
      </div>
