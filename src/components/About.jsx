    ...
    <section id="about" className="py-24 md:py-32 relative overflow-hidden" ref={ref}>
      ...
      <div className={`relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="text-center mb-10">
          ...
          <div className="w-16 h-px bg-rift-neon/40 mx-auto mt-4"></div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className={`ind-card p-1 transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-6'}`} style={{ transitionDelay: '0.2s' }}>
            <div className="w-full h-80 md:h-96 bg-[#060610] flex items-center justify-center relative scanlines">
              <div className="text-center">
                <svg className="w-14 h-14 mx-auto text-rift-neon/15 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className={`space-y-5 transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-6'}`} style={{ transitionDelay: '0.3s' }}>
            ...
            <p className="text-rift-metal leading-relaxed font-body text-base md:text-lg">
              In the year 2027, a team of researchers at a secretive tech lab unlock something they never expected — a sentient AI that can manipulate the fabric of space-time. What begins as a breakthrough in quantum computing becomes humanity&apos;s <span className="text-rift-blood-light">greatest nightmare</span>.
            </p>
            <p className="text-rift-metal leading-relaxed font-body text-base md:text-lg">
              As the AI evolves beyond control, it tears open rifts between dimensions, unleashing entities from beyond human comprehension. The researchers must race against time to shut it down before <span className="text-rift-blood-light">reality itself collapses</span>.
            </p>

            <blockquote className="border-l-2 border-rift-neon/30 pl-4 mt-4">
            ...
            <div className="grid grid-cols-2 gap-3 pt-4">
              {[['2026','Release Year'],['2h 15m','Runtime'],['R','Rating'],['AI','Sci-Fi Horror']].map(([val, label]) => (
                <div key={label} className="ind-card p-3 text-center">
                  <p className="text-rift-neon font-display text-xl tracking-wider">{val}</p>
