            ...
            <div className="group w-full max-w-[260px] mb-8 rainbow-border rounded-2xl">
              <div className="bg-abyss rounded-2xl overflow-hidden">
                <div className="aspect-[9/16] relative bg-abyss">
                  ...
                  <img src="/free-gift/mobile-wallpaper-preview.jpg" alt="Mobile wallpaper" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" onError={() => setMErr(true)}/>}
                </div>
              </div>
            </div>
