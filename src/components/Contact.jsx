        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className={`space-y-6 transition-all duration-[1.2s] ${vis ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`} style={{ transitionDelay: '0.3s' }}>
            ...
            <div className="glass-card p-6">
              ...
              <a href="https://wa.me/94775968200" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-c-muted font-body text-sm hover:text-c-emerald transition-colors duration-300">
